...
public class ChatControllerTest {
    ...
    public void leaveGroup() {
        ...
        chatRepository.save(groupChat()
                .setOwner(owner)
                .setMembers(newHashSet(owner, member)));
    ...
    public void changeOwner() throws JSONException {
        User owner = userRepository.save(user()
                ...
                .setUsername("owner")
                .setPassword(passwordEncoder.encode("password")));
        User newOwner = userRepository.save(user()
                .setEmail("newOwner@mail.com")
                .setUsername("newOwner")
                .setPassword(passwordEncoder.encode("password")));
        chatRepository.save(groupChat()
                .setOwner(owner)
                .setMembers(newHashSet(owner, newOwner)));
